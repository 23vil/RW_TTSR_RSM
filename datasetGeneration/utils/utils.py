...
__all__ = ['generate_movies', 'generate_tifs', 'ensure_folder', 'subfolders',
           ...
           'draw_random_tile', 'img_to_float', 'img_to_uint8', 'draw_specific_tile', 'calc_image_deviation']
...
def draw_specific_tile(img, LRcrop, box, magnification):
    ...
    SSIM = deviation[1]
    PSNR = deviation[0]
    return PIL.Image.fromarray(tile), SSIM , PSNR

#def find_ideal_slice(HR, LR, box):
